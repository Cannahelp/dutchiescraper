...
driver.get(BASE_URL + "/" + repository + "/products/")
time.sleep(1)
button = driver.find_element(By.XPATH,"//button[@aria-label='yes button']").click()
...
DUTCHIE_KEY_AGE_VERIFICATION = "jKLWGS"
...
#################################### The Riverside Dispensary Fairmont, WV ###################################

BASE_URL = "https://dutchie.com/dispensary"
repository = "the-riverside-dispensary"
CATEGORIES = ["flower", "vaporizers", "concentrates", "tinctures", "topicals"]
